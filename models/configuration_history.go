...
type ConfigurationHistory struct {
	...
	SavedBy         string    `gorm:"type:varchar(255);default:null" json:"saved_by,omitempty"` // Identifier of the user/system saving it
	SavedAt         time.Time `gorm:"default:CURRENT_TIMESTAMP" json:"saved_at"`
